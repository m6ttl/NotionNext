...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '一叶夷犹', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '还是需要做些有意义的事情', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://steve.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，人工智能，AI', // 网站关键词 英文逗号隔开
